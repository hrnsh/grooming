...
// 예약리스트 호출
var showPage=1;
reserveComListCall(showPage);

function reserveComListCall(page){	
	var loginId = "${sessionScope.loginId}";
	$.ajax({
		type:'get',
		url:'reserveComList',
...
function drawReserveComList(reserveComList){
	console.log(reserveComList);
	$('#reserveComList').empty();
	var content='';
	reserveComList.revComList.forEach(function(item, idx){ 
		content+='<tr>';
